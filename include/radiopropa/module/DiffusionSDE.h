...
*/
	    DiffusionSDE(ref_ptr<radiopropa::MagneticField> magneticField, double tolerance = 1e-4, double minStep=(10*pc), double maxStep=(1*kpc), double epsilon=0.1);

	    DiffusionSDE(ref_ptr<radiopropa::MagneticField> magneticField, ref_ptr<radiopropa::AdvectionField> advectionField, double tolerance = 1e-4, double minStep=(10*pc), double maxStep=(1*kpc), double epsilon=0.1);
	    ...
	    void setMagneticField(ref_ptr<radiopropa::MagneticField> magneticField);
	    void setAdvectionField(ref_ptr<radiopropa::AdvectionField> advectionField);
